...
public class Q3_문제_BMI {
	...
	public static void main(String[] args) {
		...
		if(bmi>=18.5 && bmi < 23) body_state ="정상체중";
		if(bmi>=23 && bmi < 25) body_state ="비만";
		if(bmi>=25 && bmi < 30) body_state ="1단계 비만";
		if(bmi>=30 && bmi < 35) body_state ="2단계 비만";
		if(bmi>=36) body_state ="3단계비만";
